...
[[ -n "$X86_PY" ]] || die "Could not find an x86_64 Python 3 under Rosetta. Install Intel Python/Rosetta."
...
shasum -a 256 \
  ...
  "${APP_NAME}_x86_64" \
  "${APP_NAME}_arm64.zip" \
  "${APP_NAME}_x86_64.zip" > checksums.txt

msg "Artifacts ready in ${DIST}"
cat <<EOF
Artifacts:
  ${DIST}/${APP_NAME}_arm64
  ${DIST}/${APP_NAME}_arm64.zip
  ${DIST}/${APP_NAME}_x86_64
  ${DIST}/${APP_NAME}_x86_64.zip
